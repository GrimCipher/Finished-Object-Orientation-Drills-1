...
let myWizard = new Wizard('Merlin', 1000, 'Eldritch Blast')
myWizard.castSpell()
...
let phone1 = new Phone('Apple', 'iPhone 13', 256, 'Silver', 999)
let phone2 = new Phone('Samsung', 'Galaxy S21', 128, 'Black', 799)
let phone3 = new Phone('Google', 'Pixel 6', 128, 'White', 699)
...
let myFirstBoat = new Boat(10, 'white', 200, 'Ocean Voyager', 'yacht', false)
